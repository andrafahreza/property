...
/*----------- Layout-16 Chart Start ----------*/
if(jQuery('#property3-chart-01').length){
  var options = {
   series: [{
   name: 'Net Profit',
   data: [50, 35, 45, 80, 65, 50]
  ...
  if (jQuery("#property3-chart-02").length) {
    var options = {
     series: [{
       name: "Desktops",
       data: [5, 30, 6, 20, 5, 18, 10]
...
if (jQuery("#property3-chart-03").length) {
  const options = {
    series: [
    {
      name: "High Time",
      data: [20, 15, 21, 18, 30, 18, 15, 20, 10, 28, 15]
    },
    {
      name: "Low Time",
      data: [7, 10, 23, 10, 19, 25, 18, 25, 30, 15, 31]
    }
  ],
    chart: {
    height: 300,
  ...
  const chart = new ApexCharts(document.querySelector("#property3-chart-03"), options);
  chart.render();
  const body = document.querySelector('body')
  if (body.classList.contains('dark')) {
    apexChartUpdate(chart, {
